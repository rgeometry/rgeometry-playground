...
var $author$project$Main$backend = $author$project$Main$Production;
...
var $author$project$Main$connectCommand = A2(
	...
	$bburdette$websocket$WebSocket$Connect(
		{address: $author$project$Main$wsBackend, name: 'TheSocket', protocol: ''}));
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$Disconnected, $author$project$Main$connectCommand);
};
var $author$project$Main$AttemptReconnect = {$: 'AttemptReconnect'};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				function () {
				if ((model.$ === 'Problem') && (model.a.$ === 'ConnectionFailed')) {
					var _v1 = model.a;
					return A2(
						$elm$time$Time$every,
						2000,
...
var $author$project$Main$ConnectionFailed = {$: 'ConnectionFailed'};
				...
				switch (_v0.a) {
					...
					case 'success':
						if (_v0.b.b && (!_v0.b.b.b)) {
							var _v1 = _v0.b;
							var hash = _v1.a;
							return $author$project$Main$Running(hash);
						} else {
							break _v0$5;
						}
					case 'warning':
...
var $author$project$Main$processResult = F2(
	function (result, model) {
		if (result.$ === 'Err') {
			...
			var wsMsg = result.a;
			if (wsMsg.$ === 'Error') {
				var error = wsMsg.a.error;
				return $author$project$Main$Problem(
					$author$project$Main$UnexpectedMessage(error));
			} else {
				var data = wsMsg.a.data;
						...
						switch (model.$) {
							...
							case 'Running':
								...
								return A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$src($author$project$Main$webBackend + ('loader.html?hash=' + hash))
										]),
									_List_Nil);
							default:
								var problem = model.a;
